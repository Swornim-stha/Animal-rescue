...
<body>
    ...
    <section class="hero">
        <div class="image">
            <div class="content">
                <div class="text">
                    <h1 style="font-weight: 200; font-size: 100px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">Dog Rescue Project</h1>
                    <h2 style="font-weight: 200; font-size: 90px; font-family: Arial, Helvetica, sans-serif;">Adopt Any Dog You Like!</h2>
                </div>
            </div>
        </div>
    </section>
...
<br><hr>
       ...
       <!-- dog 6 pic containt-->
        <div class="main-box">
            <div class="box"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCN7_IEc8Q3j-l7QVl1QrYq-Bieliacydhng&usqp=CAU" alt=""></div>
            <div class="box"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCN7_IEc8Q3j-l7QVl1QrYq-Bieliacydhng&usqp=CAU" alt=""></div>
            <div class="box"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCN7_IEc8Q3j-l7QVl1QrYq-Bieliacydhng&usqp=CAU" alt=""></div>
            <div class="box"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCN7_IEc8Q3j-l7QVl1QrYq-Bieliacydhng&usqp=CAU" alt=""></div>
